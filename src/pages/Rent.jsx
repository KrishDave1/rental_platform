...
const Rent = () => {
  ...
  return (
    <div className="flex">
      <div className="categories-container flex flex-col">
        <button
        ...
        <button
          className={`filter-button ${
            activeCategory === "dining table" ? "active" : ""
          }`}
        ...
        <button
          className={`filter-button ${
            activeCategory === "Dining Table Set" ? "active" : ""
          }`}
        ...
        <button
          className={`filter-button ${
            activeCategory === "study table" ? "active" : ""
          }`}
        ...
        <button
          className={`filter-button ${
            activeCategory === "center table" ? "active" : ""
          }`}
          onClick={() => handleFilter("dining table")}
        >
          center table
        ...
        <button
          className={`filter-button ${
            activeCategory === "study chair" ? "active" : ""
          }`}
        ...
        <button
          className={`filter-button ${
            activeCategory === "refrigerator" ? "active" : ""
          }`}
        ...
        <button
          className={`filter-button ${
            activeCategory === "cupboard" ? "active" : ""
          }`}
